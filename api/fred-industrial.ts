...
export default async function handler(req: any, res: any) {
  ...
  try {
    const url = `https://api.stlouisfed.org/fred/series/observations?series_id=INDPRO&api_key=${API_KEY}&file_type=json&sort_order=asc`;
    ...
    console.error("Industrial Production proxy error:", err);
